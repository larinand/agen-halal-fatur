...
export default function AppHeader() {
  ...
  return (
    <header className="z-50 sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap w-full bg-white border-b border-gray-200 text-sm py-2.5 lg:ps-65">
      <nav className="px-4 sm:px-6 flex basis-full items-center w-full mx-auto">
        ...
        <div className="w-full flex items-center justify-end ms-auto md:justify-between gap-x-1 md:gap-x-3">
          ...
          <div className="flex flex-row items-center justify-end gap-1">
            ...
            >
              <svg
                className="shrink-0 size-6 icon icon-tabler icons-tabler-outline icon-tabler-search"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            >
              <div className="border border-gray-200 shadow-2xs p-1 rounded-md">
                <IconBell className="shrink-0 size-6" />
              </div>
            ...
            >
              <div className="border border-gray-200 shadow-2xs p-1 rounded-md">
                <IconMail className="shrink-0 size-6" />
              </div>
            ...
            <div className="hs-dropdown relative inline-flex" ref={dropdownRef}>
              ...
              <div
                className={`absolute right-0 top-9.5 transition-[opacity,margin] duration-300 mt-2 min-w-60 bg-white shadow-md rounded-lg border divide-neutral-700 
